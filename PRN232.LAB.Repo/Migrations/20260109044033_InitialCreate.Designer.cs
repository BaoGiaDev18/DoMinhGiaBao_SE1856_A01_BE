...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PRN232.LAB.Repo.Entities.Category", b =>
                {
            ...
            modelBuilder.Entity("PRN232.LAB.Repo.Entities.NewsArticle", b =>
                {
            ...
            modelBuilder.Entity("PRN232.LAB.Repo.Entities.SystemAccount", b =>
                {
            ...
            modelBuilder.Entity("PRN232.LAB.Repo.Entities.Tag", b =>
                {
            ...
            modelBuilder.Entity("PRN232.LAB.Repo.Entities.Category", b =>
                {
                    b.HasOne("PRN232.LAB.Repo.Entities.Category", "ParentCategory")
            ...
            modelBuilder.Entity("PRN232.LAB.Repo.Entities.NewsArticle", b =>
                {
                    b.HasOne("PRN232.LAB.Repo.Entities.Category", "Category")
                        .WithMany("NewsArticles")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("FK_NewsArticle_Category");

                    b.HasOne("PRN232.LAB.Repo.Entities.SystemAccount", "CreatedBy")
                        .WithMany("NewsArticles")
            ...
            modelBuilder.Entity("NewsTag", b =>
                {
                    b.HasOne("PRN232.LAB.Repo.Entities.NewsArticle", null)
                        .WithMany()
                        .HasForeignKey("NewsArticleId")
                        .IsRequired()
                        .HasConstraintName("FK_NewsTag_NewsArticle");

                    b.HasOne("PRN232.LAB.Repo.Entities.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .IsRequired()

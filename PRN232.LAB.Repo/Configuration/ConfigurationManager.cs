...
namespace PRN232.LAB.Repo.Configuration
{
    /// <summary>
    /// Singleton Pattern: Qu?n lý c?u hình (Admin Account, Connection String)
    /// Ch? có 1 instance duy nh?t trong toàn b? ?ng d?ng

...
namespace DoMinhGiaBao_SE1856_A01_Repository.Migrations
{
    ...
    [Migration("20260109044033_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoMinhGiaBao_SE1856_A01_Repository.Entities.Category", b =>
                {
            ...
            modelBuilder.Entity("DoMinhGiaBao_SE1856_A01_Repository.Entities.NewsArticle", b =>
                {
            ...
            modelBuilder.Entity("DoMinhGiaBao_SE1856_A01_Repository.Entities.SystemAccount", b =>
                {
            ...
            modelBuilder.Entity("DoMinhGiaBao_SE1856_A01_Repository.Entities.Tag", b =>
                {
            ...
            modelBuilder.Entity("DoMinhGiaBao_SE1856_A01_Repository.Entities.Category", b =>
                {
                    b.HasOne("DoMinhGiaBao_SE1856_A01_Repository.Entities.Category", "ParentCategory")
            ...
            modelBuilder.Entity("DoMinhGiaBao_SE1856_A01_Repository.Entities.NewsArticle", b =>
                {
                    b.HasOne("DoMinhGiaBao_SE1856_A01_Repository.Entities.Category", "Category")
                        .WithMany("NewsArticles")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("FK_NewsArticle_Category");

                    b.HasOne("DoMinhGiaBao_SE1856_A01_Repository.Entities.SystemAccount", "CreatedBy")
                        .WithMany("NewsArticles")
            ...
            modelBuilder.Entity("NewsTag", b =>
                {
                    b.HasOne("DoMinhGiaBao_SE1856_A01_Repository.Entities.NewsArticle", null)
                        .WithMany()
                        .HasForeignKey("NewsArticleId")
                        .IsRequired()
                        .HasConstraintName("FK_NewsTag_NewsArticle");

                    b.HasOne("DoMinhGiaBao_SE1856_A01_Repository.Entities.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .IsRequired()
